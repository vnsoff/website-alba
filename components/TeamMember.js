        ...
        <div className="col-lg-4 text-center mb-8">
          <div className="team-member">
            ...
            <div className="flex justify-center gap-x-2 mt-4">
              <a href={twitterLink} target="_blank" rel="noopener noreferrer"><TwitterIcon/></a>
              <a href={facebookLink} target="_blank" rel="noopener noreferrer"><FacebookIcon/></a>
              <a href={linkedinLink} target="_blank" rel="noopener noreferrer"><LinkedInIcon/></a>
            </div>
          </div>
        </div>
      </main>
